		...
		<div class="row">
			<div class="col-md-9">
				<div class="card card-outline card-info">
					...
					<!-- /.card-header -->
					<div class="card-body">
						<?=form_open('', ['id' => 'form_blog'], ['blog_id' => $detail->blog_id]);?>
							<?php
                                $text = $detail->blog_text;
                                $data_parser = [
                                    'base_url' => base_url()
                                ];
                                $text = $this->parser->parse_string($text, $data_parser, true);
                                $image = $this->parser->parse_string($detail->blog_image, $data_parser, true);
                            ?>
							<img src="<?=!empty($detail->blog_image)?$image:base_url().'assets/dist/img/boxed-bg.png';?>" style="width: 100%; height: 120px" id="img-desc" class="img img-fluid" alt="">
